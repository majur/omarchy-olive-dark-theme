local M = {
  {
    ...
    opts = {
      colorscheme = function()
        ...
        set_hl("Include", { fg = colors.info })
        set_hl("Define", { fg = colors.info })
        ...
        set_hl("DiffAdd", { bg = "#2d4020" })
        set_hl("DiffChange", { bg = "#3d3520" })
        set_hl("DiffDelete", { bg = "#402525" })
        set_hl("DiffText", { bg = "#4d4520", bold = true })
